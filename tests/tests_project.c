...
{
    int nb = check_all("maps/wrong_maps/wrong_map");
...
{
    int nb = check_all("maps/wrong_maps/secund_wrong_map");
...
{
    int nb = check_all("maps/wrong_maps/nb_boxes");
...
Test(find_player, find_pos_player)
{
    ...
    map_s map = init_struct_map(res, 0);
    pos_s position;
