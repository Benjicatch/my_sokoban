...
Test(choose_move, move_left)
{
    ...
    map_s map = init_struct_map(res, "maps/secund_map", KEY_LEFT);
    pos_s position;
...
{
    char **res = load_2d_arr_from_file("maps/map");
    map_s map = init_struct_map(res, "maps/secund_map", KEY_RIGHT);
    pos_s position;
    list_t *pos_object = NULL;
    list_t *pos_X = NULL;
...
{
    char **res = load_2d_arr_from_file("maps/map");
    map_s map = init_struct_map(res, "maps/secund_map", KEY_DOWN);
    pos_s position;
    list_t *pos_object = NULL;
    list_t *pos_X = NULL;
